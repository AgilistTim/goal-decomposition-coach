...
**It's a cycle, not a one-off.** The future stays loose *because you come back*: the day after your review, invoke the coach again and paste your slice table in. It scores what landed (did the demo happen, or not), gives the slices that are now approaching the full treatment, and slides the horizon along. A goal sliced once and never revisited is just a prettier monolith — the method pays on the second visit and every one after. On plans where Claude can run scheduled tasks, the coach will offer to book the return visit for you — or just ask: *"the day after my monthly review, reopen the Goal Decomposition Coach with my latest slice table"*.
